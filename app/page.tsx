            ...
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div className="hidden sm:flex items-center gap-3">
                ...
                <button 
                  ...
                  className="text-neutral-700 dark:text-neutral-300 hover:text-neutral-900 dark:hover:text-white px-4 py-2 rounded-lg hover:bg-neutral-200/60 dark:hover:bg-white/10 transition-all duration-300 text-sm font-medium"
                >
                  Sign In
                </button>
                <button 
                  onClick={handleSignUp}
                  className="bg-gradient-to-r from-violet-600/90 to-indigo-600/90 hover:from-violet-500 hover:to-indigo-500 text-white px-6 py-2 rounded-xl text-sm font-medium transition-all duration-300 shadow-lg shadow-violet-500/25 hover:shadow-violet-500/40"
                >
                  Sign Up
                </button>
              </div>
