          ...
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <button 
                ...
                className="text-neutral-700 dark:text-neutral-300 hover:text-neutral-900 dark:hover:text-white transition-all duration-500 px-4 py-2 rounded-xl hover:bg-neutral-200/60 dark:hover:bg-white/10 font-extralight tracking-widest text-sm luxury-caption"
              >
                SIGN IN
              </button>
              <button 
